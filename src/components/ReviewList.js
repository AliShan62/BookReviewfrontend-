...
function ReviewList() {
    ...
    useEffect(() => {
        const fetchReviews = async () => {
            try {
                const response = await axios.get(`http://localhost:8080/api/v1/review/getAllReviews`);
    ...
    const handleDelete = async (reviewId) => {
        ...
        try {
            await axios.delete(`http://localhost:8080/api/v1/review/deleteReview/${reviewId}`);
    ...
    const handleEdit = async () => {
        try {
            await axios.put(`http://localhost:8080/api/v1/review/updateReview/${selectedReview._id}`, editFormData);
